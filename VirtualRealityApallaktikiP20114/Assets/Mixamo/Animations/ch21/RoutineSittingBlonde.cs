...
public class RoutineSittingBlonde : MonoBehaviour
{
    ...
    public GameObject brunette;
    public GameObject brunetteSleepSpot;
    ...
    private void unblockDoorIfOk(){
        if(Vector3.Distance(transform.position, PathPoints[0].position) <= minDistance && Vector3.Distance(brunette.transform.position, brunetteSleepSpot.transform.position) <= minDistance){
