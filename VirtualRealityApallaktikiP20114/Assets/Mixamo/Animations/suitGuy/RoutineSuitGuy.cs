...
public class RoutineSuitGuy : MonoBehaviour
{
    ...
    public GameObject suitGirl;
    public GameObject suitGirlSleepSpot;
    ...
    private void talk(){
        // // Debug.Log("Guy Talking");
        // if(!animator.GetCurrentAnimatorStateInfo(0).IsName("Acknowledging") && !animator.GetCurrentAnimatorStateInfo(0).IsName("Agreeing") && !animator.GetCurrentAnimatorStateInfo(0).IsName("Dismissing Gesture") && !animator.GetCurrentAnimatorStateInfo(0).IsName("Arm Gesture")){
    ...
    private void unblockDoorIfOk(){
        if(Vector3.Distance(transform.position, PathPoints[0].position) <= minDistance && Vector3.Distance(suitGirl.transform.position, suitGirlSleepSpot.transform.position) <= minDistance){
